        ...
        >
            <div className="container">
                <div className="flex items-center">
                    <div className="relative mr-6 flex-540 max-xl:flex-280 max-lg:flex-280 max-md:flex-100">
                        <div className="mb-10">
                            <img 
                                src="/images/xora.svg"
                                width={160}
                        ...
                        <p className="body-1 mb-10 max-w-md">
                            Try it now for free on iOS, Android, PC, Wed - whatever your flavor, we've got you covered.
                        </p>
